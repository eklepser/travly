    ...
    <div class="filters">
        ...
        <div class="duration-section">
            ...
            <div class="duration-inputs">
                <div class="input-group"><span class="input-label">от</span><input type="number" class="input-field duration-min" placeholder="3" min="1" max="365" value=""></div>
                <div class="input-group"><span class="input-label">до</span><input type="number" class="input-field duration-max" placeholder="30" min="1" max="365" value=""></div>
            </div>
        </div>
        <div class="range-section">
            <span class="section-title">Длительность тура (ночей)</span>
            <div class="range-slider"><input type="range" class="slider nights-slider" min="1" max="365" value="365" step="1"></div>
        </div>
