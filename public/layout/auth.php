<main class="auth-main">
    <div class="auth-container">
        <div class="auth-card">
            ...
            <button class="submit-btn" onclick="location.href='?page=me'"> Продолжить с VK </button>
            ...
            <div class="auth-footer">
                <p>Нет аккаунта? <a onclick="location.href='?page=registration.php'">Зарегистрироваться</a></p>
            </div>
